package com.arturlasok.feature_creator.presentation.creator_editmodule
...
fun EditModuleScreen(
    editModuleViewModel: EditModuleViewModule = hiltViewModel(),
    ...
    val dataStoreDarkTheme = editModuleViewModel.darkFromStore().collectAsState(initial = 0)
